...
import { Cloud, Settings, FileText, Activity, ChevronLeft, ChevronRight, Plus, Zap, Terminal, Globe, Wifi, WifiOff, Loader2, CheckCircle, AlertCircle, RefreshCw } from "lucide-react";
...
export function Sidebar({ isCollapsed, onToggle }: SidebarProps) {
  ...
  return (
    <div className={cn(
      "h-screen bg-card border-r border-border flex flex-col transition-[width] duration-300",
